...
public class Const{
    ...
    public static final String MARVINS_BUCKET_NAME = "marvinsbucket";
    public static final String RECOGNIZABLE_OBJECTS_BUCKET ="detectionobjects";
    ...
    public static final boolean UPDATE_DYNAMO_DB = true;
    ...
    public static final String IMAGE_LOADING_TAG="imageloading";
